...
int main(int argc, char* argv[])
{
    ...
    cout << "Passwd, command: " << putbuf << command << endl; 
    ...
    if ( strlen(getbuf) == 0)
    {
    cout << endl << "Command error!"<< getbuf << endl;
    }
